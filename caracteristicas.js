...
switch (producto) {
  ...
  case "parisEspresso":
    ...
    var character = [
      ...
      {
        Nombre:
          "Pantalla LCD integrada de 10.1” para visualización de imágenes.",
      },
      {
        Nombre: "2 contenedores de producto para leche en polvo y chocolate.",
      },
      {
        Nombre: "Tolva para café en grano visible desde el exterior de 1,2 kg..",
      },
      {
      ...
      {
        Nombre: "Ancho 30 cm - Fondo 50 cm - Alto 73 cm.",
      },
      {
        Nombre: "Peso: 28 kg.",
      },
  ...
  case "parisSoluble":
    ...
    var character = [
      ...
      {
        Nombre: "4 contenedores de producto para leche en polvo y chocolate.",
      },
      {
        Nombre: "Mayor higiene, frescura y presentación de los productos.",
      },
  ...
  case "turin":
    var character = [
      {
        Nombre: "Dispensa 3 bebidas diferentes.",
      },
      {
  ...
  case "berna12L":
    var character = [
      ...
      {
        Nombre: "Dimensiones: alto 72 cm - ancho 27 cm - fondo 38 cm.",
      },
      {
  ...
  case "grecia181T":
    var character = [
      {
        Nombre:
          "Excelente para bebidas densas como: avena, yogurt, kumis y jugos.",
      },
      {
        Nombre: "Para panaderías, fruterías, restaurantes y bares.",
      },
      {
        Nombre: "Capacidad de 15 litros.",
      },
      {
        Nombre: "Control automático de temperatura.",
      },
      {
        Nombre: "Temperatura de enfriado 4˚C y 6˚C.",
      },
      {
        Nombre: "Agitador central de aspas.",
      },
      {
        Nombre: "Bajo consumo de energía.",
      },
      {
        Nombre: "Alto 72,8cm - Ancho 25cm - Fondo 38,6cm.",
      },
      {
        Nombre: "Peso 20kg..",
      },
  ...
  case "grecia182T":
    var character = [
      ...
      {
        Nombre: "Capacidad de 15 litros por tanque.",
      },
      {
        Nombre: "Control automático de temperatura.",
      },
      ...
      {
        Nombre: "Alto 72,8cm - Ancho 50cm - Fondo 38,6cm.",
      },
      {
        Nombre: "Peso 32kg..",
      },
  ...
  case "neve110":
    var character = [
      {
        Nombre:
          "De una boquilla altamente eficiente.",
      },
      {
        Nombre: "Cubierta en acero inoxidable.",
      },
      {
        Nombre: "Maquina de sobremesa.",
      },
      {
        Nombre: "Programación electronica.",
      },
      {
        Nombre: "Control automático de congelación.",
      },
      {
        Nombre: "15% inyección de aire por gravedad.",
      },
      {
        Nombre: "Compresor Aspera de 1/2 HP.",
      },
      {
        Nombre: "Potencia de 200 W.",
      },
      {
        Nombre: "Alto 71cm - Ancho 22cm - Fondo 73cm.",
      },
      {
        Nombre: "Peso: 43 Kg.",
      },
      {
        Nombre: "Alimentación: 110V - polo a tierra.",
      },
      {
        Nombre: "Garantía 12 meses.",
      },
  ...
  case "neve220":
    var character = [
      ...
      {
        Nombre: "Alimentación: 220V - polo a tierra.",
      },
      {
        Nombre: "Garantía 12 meses.",
      },
  ...
  case "asis":
    var character = [
      {
        Nombre:
          "Diseño práctico y tradicional. Ideal para oficinas, sala de docentes, y hoteles.",
      },
      {
        Nombre: "Capacidad 120 tazas por hora , 1.7 litros en 7 minutos.",
      },
      {
        Nombre: "Termo de 1.7 litros fabricado en acero inoxidable incluido con la máquina.",
      },
      {
        Nombre: "Incluye 2 Porta vasos con capacidad de 100 unidades.",
      },
      {
        Nombre: "Termo fabricado en acero inoxidable.",
      },
      {
        Nombre: "Tanque en plástico para agua.",
      },
      {
        Nombre: "Bajo consumo de energía.",
      },
      {
        Nombre: "Alto 51cm - Ancho 22cm - Fondo 37cm.",
      },
      {
        Nombre: "Peso: 6kg.",
      },
      {
        Nombre: "Alimentación: 1450W - 12 A.",
      },
      {
        Nombre: "Voltaje: 110v.",
      },
      {
        Nombre: "Garantía 3 meses.",
      },
